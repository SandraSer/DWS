...
function Display_2()
    ...
    <td class=cont> Не все поля формы заполнены! </td><tr>
...
$nick1 = mb_convert_encoding($nick, 'utf-8', 'cp1251');
$password1 = mb_convert_encoding($passwd, 'utf-8', 'cp1251');
$email1 = mb_convert_encoding($email, 'utf-8', 'cp1251');
$fio1 = mb_convert_encoding($fio, 'utf-8', 'cp1251');	
	
$query="insert into info (nick, password, email, fio) values ('$nick1', '$password1','$email1','$fio1')";
...
$services -> Setnazvanie('Лабораторные работы по курсу Разработка интернет приложений в сфере коммерциии посредством PHP и MySQL <br> Студентки группы ПИв-171: Сержантовой Александры Сергеевны<br> Проверил: к.т.н. доц. Назимов А.С.');
